...
values=`sudo sdm120c -a 2 -b 9600 -z 10 -w 5 -j 1 -i -p -v -c -P N -q /dev/ttyUSB1`
...
#echo Valid read
curl -s "${DOMOTICZ}&param=udevice&idx=58&nvalue=0&svalue=$W;$WH"
mosquitto_pub -h MQTTBROKER -u USERNAME -P PASSWORD -t /sdm120/electricity_aquarea -m "{\"power\":$W,\"energy\":$WH,\"voltage\":$V,\"current\":$A,\"update_timestamp\":$TS}"
else
echo Invalid read
